...
router
  ...
  router.route("/search").post(verifyToken, verifyAdmin, eventController.searchEvents);
  router.route("/get-event/:id").get(verifyToken, verifyAdmin, eventController.getEventById);
